...
/** @typedef {{ mode: "off"|"letsencrypt"|"selfsigned"|"byo", httpPort: number, httpsPort: number, domain: string, email: string, certPath: string, keyPath: string, selfSignedDays: number }} NetworkConfig */
